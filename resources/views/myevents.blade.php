                ...
                <div class="col-md-8">
                    ...
                    <div class="featured-post-wide thumbnail">
                        ...
                        <div class="featured-text relative-left">
                            <h3 class="primary"><a href="{{ URL::to('newsitem/'.$news->slug) }}">{{$news->title}}</a></h3>
                            <p>
                                {!! $news->content !!}
                            </p>
                            <p>
                            ...
                            <hr>
                            <p class="text-right">
                                <a href="{{ URL::to('newsitem/'.$news->slug) }}" class="btn btn-primary text-white">Read more</a>
                            </p>
                        </div>
                        <!-- /.featured-text -->
                    </div>
