                    ...
                    <div class="panel-body">
                        <div class="flatbuttons">
                            <ul>
                                ...
                                <li>
                                    <a href="#" class="button button-border button-seccess button-pill">button</a>
                                </li>
                                <li>
                                    <a href="#" class="button button-border button-info button-large button-circle">button</a>
                                </li>
                                <li>
                                    <a href="#" class="button button-border button-warning">
                    ...
                    <div class="panel-body">
                        <div class="text-left">
                            <ul class="list-inline">
                                ...
                                <li>
                                    <a href="#"
                                       class="button button-3d button-info button-circle button-large">button</a>
                                </li>
                                <li>
                    ...
                    <div class="panel-body">
                        <div class="flatbuttons_size">
                            <ul>
                                ...
                                <li>
                                    <a href="#" class="button button-rounded buttont-primary button-tiny">button</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-12 text-center">
                                ...
                                <br/>
                                <div class="ui-group-buttons">
                                    <button type="button" class="btn btn-primary btn-lg" style="padding-right:15px">Large button</button>
                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-4 col-xs-6 col-sm-6">
                                ...
                                <br/>
                                <button type="button" class="btn btn-labeled btn-warning text-left">
                                            <span class="btn-label">
