            ...
            <div class="col-md-6">
                ...
                <div class="panel panel-primary" id="hidepanel1">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" action="#" method="patch">
                            ...
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <div class="col-md-12 text-right">
                                        <input type="submit" name="btnSubmit" id="btnSubmit" value="Register" class="btn btn-primary btn-md btn-responsive">
                                    </div>
                                </div>
                            </fieldset>
                        </form>
                ...
                <div class="panel panel-success" id="hidepanel6">
                    ...
                    <div class="panel-body">
                        <form action="#" method="patch">
                            ...
                            <input href="#" type="submit" class="btn btn-responsive btn-default" role="button">
