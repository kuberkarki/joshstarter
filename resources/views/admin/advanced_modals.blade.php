...
<section class="content-header">
  ...
  <section class="content">
                  ...
                  <div class="panel-body modal-panel">
                      <div class="row">
                          <div class="col-md-3">
                              ...
                              <br>
                              <button class="btn btn-effect btn-purple md-trigger" data-modal="modal-1">Fade in &amp; Scale</button>
                              <button class="btn btn-effect btn-purple md-trigger" data-modal="modal-2">Slide in (right)</button>
                              <button class="btn btn-effect btn-purple md-trigger" data-modal="modal-3">Slide in (bottom)</button>
                          </div>
                          <div class="col-md-3">
                              <h3>
                              ...
                              <button class="btn btn-effect btn-green1 md-trigger" data-modal="modal-8">3D Flip (horizontal)</button>
                              <button class="btn btn-effect btn-green1 md-trigger" data-modal="modal-9">3D Flip (vertical)</button>
                              <button class="btn btn-effect btn-green1 md-trigger" data-modal="modal-10">3D Sign</button>
                              <button class="btn btn-effect btn-green1 md-trigger" data-modal="modal-14">3D Rotate Bottom</button>
                              <button class="btn btn-effect btn-green1 md-trigger" data-modal="modal-15">3D Rotate In Left</button>
                              <button class="btn btn-effect btn-green1 md-trigger" data-modal="modal-13">3D Slit</button>
                          </div>
                          <div class="col-md-3">
                              <h3>
                                  <strong>Other</strong>
                              ...
                              <br>
                              <button class="btn btn-effect btn-orange md-trigger" data-modal="modal-4">Newspaper</button>
                              <button class="btn btn-effect btn-orange md-trigger" data-modal="modal-5">Fall</button>
                              <button class="btn btn-effect btn-orange md-trigger" data-modal="modal-6">Side Fall</button>
                              <button class="btn btn-effect btn-orange md-trigger" data-modal="modal-7">Sticky Up</button>
                              <button class="btn btn-effect btn-orange md-trigger" data-modal="modal-11">Super Scaled</button>
                          </div>
                          <div class="col-md-3">
                              <h3>
                                  <strong>Color</strong>
                              ...
                              <button class="btn btn-effect btn-yellow md-trigger" data-modal="modal-16">yellow</button>
                              <button class="btn btn-effect btn-purple md-trigger" data-modal="modal-17">blue</button>
                              <button class="btn btn-effect btn-green md-trigger" data-modal="modal-18">green</button>
                              <button class="btn btn-effect btn-red md-trigger" data-modal="modal-21">red</button>
                              <button class="btn btn-effect btn-default md-trigger" data-modal="modal-19">White</button>
                              <button class="btn btn-effect btn-warning md-trigger" data-modal="modal-20">orange</button>
                          </div>
                      </div>
                  </div>
              </div>
      ...
      <div class="md-modal md-effect-1 md-content-yellow" id="modal-16">
