...
<div class="row">
    <div class="table-responsive">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div class="row">
                          @if($event->photo)
                             <div class="col-sm-6"><img src="{{ URL::to('thumbnail/'.$event->photo)  }}" class="img-responsive" alt="Image"></div>
                        @else
                        <div class="col-sm-6"><img width="231" src="{{ asset('assets/images/eventday/adspic.jpg') }}" class="img-responsive"></div>
                          ...
                          <div class="col-sm-6">
                           ...
                           <a href="{{ route('event-view-reviews',$event) }}" class="manage">View Reviews</a>
                          </div>
                        </div>
                    </td>
                    ...
                    <!-- <button class="btn btn-primary btn-xs" data-title="Edit" href="{!! route('edit-ads',$event)!!}"  data-toggle="modal" data-target="#edit" ><span class="glyphicon glyphicon-pencil"></span></button> --></p>
                    </td>
        ...
        @include('pagination.limit_links', ['paginator' => $events])
    </div>
    </div>
    </div>
    </div>
