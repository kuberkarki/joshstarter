            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        ,$event->type, ['class' => 'form-control']) !!}
                    </div>
                        
                    
                   <div class="form-group">
                   {!! Form::label('location', 'Location: ') !!}
                   <input id="geocomplete" value="{!! $event->location !!}" type="text" placeholder="Type in an address" class='form-control' name="location" />
                   <!--  <input id="find" type="button" value="find" /> -->
                                    ...
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        ...
                                        <div>
                                                            <span class="btn btn-primary btn-file">
                                                                ...
                                                                <input value="{!! $event->photo !!}" type="file" name="photo_image" id="pic" />
                                                            </span>
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::text('video_link', $event->video_link, ['class' => 'form-control']) !!}
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::text('sponsor', $event->sponsor, ['class' => 'form-control']) !!}
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::textarea('contact_person', $event->contact_person, ['class' => 'form-control']) !!}
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::text('contact_person_address', $event->conatct_person_address, ['class' => 'form-control']) !!}
                    </div>
