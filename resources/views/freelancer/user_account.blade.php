...
<section class="bannerWrapper innerBanner">
  <div class="searchWrap">
    <div class="container">
        <h1>Freelancer Profile Settings</h1>
                    ...
                    <div class="position-center">
                        ...
                        <form role="form" id="tryitForm" class="form-horizontal" enctype="multipart/form-data"
                            ...
                            <div class="form-group {{ $errors->first('duration', 'has-error') }}">
                                <label class="col-lg-2 control-label" for="postal">Duration:</label>
                                <div class="col-lg-6">
                                    <div class="input-group">
                                                        <span class="input-group-addon">
                                                            <i class="fa fa-fw fa-dot-circle-o text-primary"></i>
                                                        </span>
                                        <input type="text" placeholder=" " id="duration" class="form-control"
                                               name="duration" value="{!! old('duration',$user->duration) !!}"/>
                                    </div>
                                    <span class="help-block">{{ $errors->first('postal', ':message') }}</span>
                                </div>
                            </div>
                            ...
                            <div class="form-group {{ $errors->first('office_number', 'has-error') }}">
                                <label class="col-lg-2 control-label" for="postal">Landline:</label>
                                <div class="col-lg-6">
                                    <div class="input-group">
                                                        <span class="input-group-addon">
