    ...
    <div class="breadcum">
        <div class="container">
            ...
            <!-- <div class="pull-right">
                <i class="livicon icon3" data-name="doc-landscape" data-size="20" data-loop="true" data-c="#3d3d3d" data-hc="#3d3d3d"></i> {{$news->title}}
            </div> -->
        </div>
    </div>
    @stop
...
@section('content')
    ...
    <div class="container">
        <h2 class="primary marl12">{{$news->title}}</h2>
        <div class="row content">
            ...
            <div class="col-sm-8 col-md-8">
                    ...
                    <div class="the-box no-border news-detail-content">
                        <p class="additional-post-wrap">
                            <span class="additional-post">
                                    <i class="livicon" data-name="user" data-size="13" data-loop="true" data-c="#5bc0de" data-hc="#5bc0de"></i> by&nbsp;<a href="#">{{$news->author->first_name . ' ' . $news->author->last_name}}</a>
                                </span>
                            <span class="additional-post">
                                    <i class="livicon" data-name="clock" data-size="13" data-loop="true" data-c="#5bc0de" data-hc="#5bc0de"></i><a href="#"> {{$news->created_at->diffForHumans()}} </a>
                                </span>
                            <span class="additional-post">
                                    <i class="livicon" data-name="comment" data-size="13" data-loop="true" data-c="#5bc0de" data-hc="#5bc0de"></i><a href="#"> {{$news->comments->count()}} comments</a>
                                </span>
                        </p>
                ...
                <h3 class="comments">{{$news->comments->count()}} Comments</h3><br />
                <ul class="media-list">
                ...
                {!! Form::open(array('url' => URL::to('newsitem/'.$news->id.'/comment'), 'method' => 'post', 'class' => 'bf', 'files'=> true)) !!}
